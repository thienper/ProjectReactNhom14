...
const heroImageUrl =
  "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1400&q=80";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // For demo purposes we'll use the same API and modify the data
        const [productResponse, reviewResponse] = await Promise.all([
          axios.get("https://67dbde0a1fd9e43fe476439b.mockapi.io/heels"),
        ...
        // Modify the data for heel categories
        const enhancedData = productData.slice(0, 30).map((product) => ({
          ...product,
          rating: (Math.random() * 2 + 3).toFixed(1),
          category: ["stiletto", "block", "kitten"][
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black to-transparent flex items-center">
            <div className="text-white p-6 md:p-16 max-w-2xl">
              ...
              <p className="text-lg md:text-xl mb-6 opacity-90">
                Khám phá bộ sưu tập giày cao gót cao cấp, tôn dáng và tạo nên vẻ
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-1/4 hidden md:block">
            <div className="bg-white rounded-lg shadow-sm p-4 sticky top-4">
              ...
              {/* Lọc theo loại gót */}
              <h3 className="font-bold border-b pb-2 mb-3">Loại Gót</h3>
              <div className="flex flex-col space-y-2 mb-6">
                ...
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    ...
                    name="category"
                    className="form-radio text-blue-600 h-4 w-4"
                    checked={activeCategory === "stiletto"}
                    onChange={() => setActiveCategory("stiletto")}
                  />
                  <span className="ml-2 text-gray-700">Stiletto</span>
                </label>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    type="radio"
                    name="category"
                    className="form-radio text-blue-600 h-4 w-4"
                    checked={activeCategory === "block"}
                    onChange={() => setActiveCategory("block")}
                  />
                  <span className="ml-2 text-gray-700">Gót vuông</span>
                </label>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    type="radio"
                    name="category"
                    className="form-radio text-blue-600 h-4 w-4"
                    checked={activeCategory === "kitten"}
                    onChange={() => setActiveCategory("kitten")}
                  />
                  <span className="ml-2 text-gray-700">Gót thấp</span>
                </label>
              </div>
              ...
              <div className="flex flex-col space-y-2 mb-6">
                ...
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  />
                  <span className="ml-2 text-gray-700">Dưới 1 triệu đồng</span>
                </label>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    type="radio"
                    ...
                    onChange={() => setPriceRange("1m-2m")}
                  />
                  <span className="ml-2 text-gray-700">1 - 2 triệu đồng</span>
                </label>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    type="radio"
                    ...
                    onChange={() => setPriceRange("over2m")}
                  />
                  <span className="ml-2 text-gray-700">Trên 2 triệu đồng</span>
                </label>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold">Stiletto</h3>
              <a
                href="#"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {getStilettoHeels().map((heel) => (
                <div key={heel.id} className="stiletto-category">
                  {renderProductCard(heel)}
                </div>
              ))}
            </div>
          </div>

          {/* Block Heels Collection */}
          <div className="mb-16">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold">Gót Vuông</h3>
              <a
                href="#"
                className="text-blue-600 hover:underline flex items-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {getBlockHeels().map((heel) => (
                <div key={heel.id} className="block-category">
                  {renderProductCard(heel)}
                </div>
              ))}
            </div>
          ...
          {/* Kitten Heels Collection */}
          <div className="mb-16">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold">Gót Thấp</h3>
              <a
                href="#"
                className="text-blue-600 hover:underline flex items-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {getKittenHeels().map((heel) => (
                <div key={heel.id} className="kitten-category">
                  {renderProductCard(heel)}
                </div>
              ))}
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {getNewestArrivals().map((heel) => (
                <div key={heel.id}>{renderProductCard(heel)}</div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {getDiscountedProducts().map((heel) => (
                <div key={heel.id}>{renderProductCard(heel)}</div>
              ))}
            </div>
          </div>

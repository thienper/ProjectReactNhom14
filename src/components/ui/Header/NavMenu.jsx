    ...
    return (
        <Nav className="mx-auto align-items-center">
            ...
            <NavDropdown
                title="Giày nam"
                id="men-dropdown"
                className="nav-dropdown-custom mx-1 focus:border-none"
            >
                <NavDropdown.Item as={Link} to="/mens-sports" className="dropdown-item-custom">Giày thể thao nam</NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/mens-sandals" className="dropdown-item-custom">Giày Sandal nam</NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/mens-leather" className="dropdown-item-custom">Giày tây nam</NavDropdown.Item>
            </NavDropdown>
            ...
            >
                ...
                <NavDropdown.Item as={Link} to="/womens-sandals" className="dropdown-item-custom">Giày sandal nữ</NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/womens-heels" className="dropdown-item-custom">Giày cao gót</NavDropdown.Item>
            </NavDropdown>
